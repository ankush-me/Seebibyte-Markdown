...
newsCard.prototype.divify = function() {
	...
	this.highlight+'</p></div></div><div data-index="2" ><span><a href="https://twitter.com/share" class="twitter-share-button" data-size="large" data-text="'+this.title+'\n" data-url="'+window.location.href+'" data-dnt="true" data-show-count="false"></a></span><span data-act="1" class="icon icon-carat-down" ></span></div><div data-index="3" ><p class="long hide">'+
	this.content+'</p></div>';
